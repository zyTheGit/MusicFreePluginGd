var $8Mgqq$axios = require("axios");
var $8Mgqq$qs = require("qs");
...
const $969787c686ce746c$export$c5fbcfb2b492c83d = {
    // 搜索
    search: (params)=>(0, ($parcel$interopDefault($8Mgqq$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($8Mgqq$qs))).stringify(params)
        }).then(({ data: data })=>{
    ...
    // 获取音源
    getMediaSource: (params)=>(0, ($parcel$interopDefault($8Mgqq$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($8Mgqq$qs))).stringify(params)
        }).then(({ data: data })=>data),
    // 获取音乐信息
    getMusicInfo: (params)=>(0, ($parcel$interopDefault($8Mgqq$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($8Mgqq$qs))).stringify(params)
        }).then(({ data: data })=>data),
    // 获取歌词
    getLyric: (params)=>(0, ($parcel$interopDefault($8Mgqq$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($8Mgqq$qs))).stringify(params)
        }).then(({ data: data })=>data)
...
$parcel$export(module.exports, "default", () => $75e37e94a0e553a3$export$2e2bcd8739ae039);

var $l5i2x = parcelRequire("l5i2x");

var $8ItRl = parcelRequire("8ItRl");
const { defaultConfig: $75e37e94a0e553a3$var$defaultConfig, pluginConfig: $75e37e94a0e553a3$var$pluginConfig, ...$75e37e94a0e553a3$var$optMethods } = $l5i2x;
$75e37e94a0e553a3$var$defaultConfig.source = (0, $8ItRl.sourceMap).tencent;
const $75e37e94a0e553a3$var$pluginInstance = {
    platform: "\u963F\u4E5DQQ",
    ...$75e37e94a0e553a3$var$pluginConfig,
    ...$75e37e94a0e553a3$var$optMethods
};
var $75e37e94a0e553a3$export$2e2bcd8739ae039 = $75e37e94a0e553a3$var$pluginInstance;
