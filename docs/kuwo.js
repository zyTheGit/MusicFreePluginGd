var $9uWZs$axios = require("axios");
var $9uWZs$qs = require("qs");
...
const $969787c686ce746c$export$c5fbcfb2b492c83d = {
    // 搜索
    search: (params)=>(0, ($parcel$interopDefault($9uWZs$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($9uWZs$qs))).stringify(params)
        }).then(({ data: data })=>{
    ...
    // 获取音源
    getMediaSource: (params)=>(0, ($parcel$interopDefault($9uWZs$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($9uWZs$qs))).stringify(params)
        }).then(({ data: data })=>data),
    // 获取音乐信息
    getMusicInfo: (params)=>(0, ($parcel$interopDefault($9uWZs$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($9uWZs$qs))).stringify(params)
        }).then(({ data: data })=>data),
    // 获取歌词
    getLyric: (params)=>(0, ($parcel$interopDefault($9uWZs$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($9uWZs$qs))).stringify(params)
        }).then(({ data: data })=>data)
...
$parcel$export(module.exports, "default", () => $a447d476887c7538$export$2e2bcd8739ae039);

var $l5i2x = parcelRequire("l5i2x");

var $8ItRl = parcelRequire("8ItRl");
const { defaultConfig: $a447d476887c7538$var$defaultConfig, pluginConfig: $a447d476887c7538$var$pluginConfig, ...$a447d476887c7538$var$optMethods } = $l5i2x;
$a447d476887c7538$var$defaultConfig.source = (0, $8ItRl.sourceMap).kuwo;
const $a447d476887c7538$var$pluginInstance = {
    platform: "\u963F\u4E5DKW",
    ...$a447d476887c7538$var$pluginConfig,
    ...$a447d476887c7538$var$optMethods
};
var $a447d476887c7538$export$2e2bcd8739ae039 = $a447d476887c7538$var$pluginInstance;
