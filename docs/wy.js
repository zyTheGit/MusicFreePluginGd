var $arpAJ$axios = require("axios");
var $arpAJ$qs = require("qs");
...
const $969787c686ce746c$export$c5fbcfb2b492c83d = {
    // 搜索
    search: (params)=>(0, ($parcel$interopDefault($arpAJ$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($arpAJ$qs))).stringify(params)
        }).then(({ data: data })=>{
    ...
    // 获取音源
    getMediaSource: (params)=>(0, ($parcel$interopDefault($arpAJ$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($arpAJ$qs))).stringify(params)
        }).then(({ data: data })=>data),
    // 获取音乐信息
    getMusicInfo: (params)=>(0, ($parcel$interopDefault($arpAJ$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($arpAJ$qs))).stringify(params)
        }).then(({ data: data })=>data),
    // 获取歌词
    getLyric: (params)=>(0, ($parcel$interopDefault($arpAJ$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($arpAJ$qs))).stringify(params)
        }).then(({ data: data })=>data)
...
$parcel$export(module.exports, "default", () => $164281a84a37fdfc$export$2e2bcd8739ae039);

var $l5i2x = parcelRequire("l5i2x");

var $8ItRl = parcelRequire("8ItRl");
const { defaultConfig: $164281a84a37fdfc$var$defaultConfig, pluginConfig: $164281a84a37fdfc$var$pluginConfig, ...$164281a84a37fdfc$var$optMethods } = $l5i2x;
$164281a84a37fdfc$var$defaultConfig.source = (0, $8ItRl.sourceMap).tencent;
const $164281a84a37fdfc$var$pluginInstance = {
    platform: "\u963F\u4E5DWY",
    ...$164281a84a37fdfc$var$pluginConfig,
    ...$164281a84a37fdfc$var$optMethods
};
var $164281a84a37fdfc$export$2e2bcd8739ae039 = $164281a84a37fdfc$var$pluginInstance;
