var $jMqRV$axios = require("axios");
var $jMqRV$qs = require("qs");
...
const $969787c686ce746c$export$c5fbcfb2b492c83d = {
    // 搜索
    search: (params)=>(0, ($parcel$interopDefault($jMqRV$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($jMqRV$qs))).stringify(params)
        }).then(({ data: data })=>{
    ...
    // 获取音源
    getMediaSource: (params)=>(0, ($parcel$interopDefault($jMqRV$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($jMqRV$qs))).stringify(params)
        }).then(({ data: data })=>data),
    // 获取音乐信息
    getMusicInfo: (params)=>(0, ($parcel$interopDefault($jMqRV$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($jMqRV$qs))).stringify(params)
        }).then(({ data: data })=>data),
    // 获取歌词
    getLyric: (params)=>(0, ($parcel$interopDefault($jMqRV$axios)))({
            method: "POST",
            url: $969787c686ce746c$var$GD_SOURCE_URL,
            data: (0, ($parcel$interopDefault($jMqRV$qs))).stringify(params)
        }).then(({ data: data })=>data)
...
$parcel$export(module.exports, "default", () => $2add084a21e89887$export$2e2bcd8739ae039);

var $l5i2x = parcelRequire("l5i2x");

var $8ItRl = parcelRequire("8ItRl");
const { defaultConfig: $2add084a21e89887$var$defaultConfig, pluginConfig: $2add084a21e89887$var$pluginConfig, ...$2add084a21e89887$var$optMethods } = $l5i2x;
$2add084a21e89887$var$defaultConfig.source = (0, $8ItRl.sourceMap).tidal;
const $2add084a21e89887$var$pluginInstance = {
    platform: "\u963F\u4E5DTIDAL",
    ...$2add084a21e89887$var$pluginConfig,
    ...$2add084a21e89887$var$optMethods
};
var $2add084a21e89887$export$2e2bcd8739ae039 = $2add084a21e89887$var$pluginInstance;
